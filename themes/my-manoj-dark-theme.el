...
;; '(default ((t (:background "#0B0B3B" :foreground "WhiteSmoke"))))
...
;; '(hl-line  ((t (:background "grey10" :foreground "Old Lace"))))
 '(hl-line  ((t (:background "grey22" :foreground "Old Lace"))))
;; '(hl-line  ((t (:background "dark slate blue" :foreground "Old Lace"))))
 ...
 '(mode-line-highlight ((t (:box t :height 0.9))))
